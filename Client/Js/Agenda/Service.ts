...
export default class DataService {
    ...
    public baseServicepath: string = this.dnn.dnnSF(this.moduleId).getServiceRoot('Connect/Agenda');
    ...
    public getItems(category: number, city: string, searchText: string, sortField: string, sortOrder: string, pageSize: number, pageIndex: number, success: Function): void {
        this.ajaxCall('GET', this.baseServicepath, 'Item', 'List', undefined, {}, { category, city, searchText, sortField, sortOrder, pageSize, pageIndex }, success)
    }
    public updateItem(item: any, success: Function): void {
        this.ajaxCall('POST', this.baseServicepath, 'Item', 'Update', undefined, {}, item, success);
    }
}
