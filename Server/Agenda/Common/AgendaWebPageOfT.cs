...
{
    public abstract class AgendaWebPage<TModel> : DnnWebViewPage<TModel>
    {
        ...
        public override void InitHelpers()
        {
            ...
            AgendaModuleContext = new ContextHelper(ViewContext);
        }
        ...
        {
            AgendaModuleContext.RequirePermissionLevel(level);
        }
